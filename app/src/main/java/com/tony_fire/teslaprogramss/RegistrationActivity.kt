package com.tony_fire.teslaprogramss
...
import com.tony_fire.teslaprogramss.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.pqijnw.setOnClickListener {
            ...
            binding.pqijnw.setBackgroundResource(R.drawable.bg_color_select)
            binding.pqijnw.isEnabled = false

            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f4d230a3d18cbe61980ae3a",ed2stName,ed_tel,"njuytfvbhgfdswqa")
                    ...
                    if(response.isSuccessful){
                        ...
                        when {
                            response.body()?.data?.pr.equals("success") -> {
                                ...
                                startActivity(i)
                                binding.pqijnw.setBackgroundResource(R.drawable.bg_selector)
                                binding.pqijnw.isEnabled = true
                            }
